...
func AlmaCrupHandler(c echo.Context) error {
  ...
  fs := alma.FunMap{ BoundwithPF: alma.ProcessBoundwith, HoldingPF: alma.ProcessHolding, ItemsPF: alma.ProcessItems, ItemPF: alma.ProcessItem, CallWorker: alma.CallWorker, AfterBib: as.AfterBibCreate, SetHolding: oclc.SetHolding }
